Rails.application.routes.draw do
  ...
  get 'categorias/:name', to: 'public_properties#category', as: 'public_properties_category'
  ...
  get 'propiedades/busqueda', to: 'public_properties#search', as: 'public_properties_search'

  post 'upload/photo', to: 'properties#upload'
